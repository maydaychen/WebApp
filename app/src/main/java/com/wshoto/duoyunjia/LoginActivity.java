...
public class LoginActivity extends AppCompatActivity {
    ...
    @BindView(com.wshoto.duoyunjia.R.id.editText)
    EditText mEditText;
    @BindView(com.wshoto.duoyunjia.R.id.ll_1)
    LinearLayout mLl1;
    @BindView(com.wshoto.duoyunjia.R.id.iv_yanzhengma)
    ImageView mIvYanzhengma;
    @BindView(com.wshoto.duoyunjia.R.id.bt_send_yanzhengma)
    TextView mBtSendYanzhengma;
    @BindView(com.wshoto.duoyunjia.R.id.et_yanzhengma)
    EditText mEtYanzhengma;
    @BindView(com.wshoto.duoyunjia.R.id.ll_yanzhengma)
    RelativeLayout mLlYanzhengma;
    @BindView(com.wshoto.duoyunjia.R.id.line_yanzhengma)
    View mLineYanzhengma;
    @BindView(com.wshoto.duoyunjia.R.id.ll_login)
    LinearLayout mLlLogin;
    @BindView(com.wshoto.duoyunjia.R.id.imageView)
    ImageView mImageView;
    @BindView(com.wshoto.duoyunjia.R.id.iv_start)
    LinearLayout mIvStart;
    @BindView(com.wshoto.duoyunjia.R.id.rl_login)
    RelativeLayout mRlLogin;
    @BindView(com.wshoto.duoyunjia.R.id.tv_support)
    TextView mTvSupport;
    @BindView(com.wshoto.duoyunjia.R.id.test)
    ImageView mTest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wshoto.duoyunjia.R.layout.activity_login);
        ...
        loading = new Loading_view(this, com.wshoto.duoyunjia.R.style.CustomDialog);
...
//        };
    ...
    @OnClick({com.wshoto.duoyunjia.R.id.bt_send_yanzhengma, com.wshoto.duoyunjia.R.id.button})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case com.wshoto.duoyunjia.R.id.bt_send_yanzhengma:
                ...
                break;
            case com.wshoto.duoyunjia.R.id.button:
